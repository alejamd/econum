...
apply(spe, 2, range)
(ab <- table(unlist(spe)))
dev.new(title = "Distribuição de classe de abundância", 
  noRStudioGD = TRUE
)
barplot(ab, 
  las = 1,
...
```{r}
dev.new(title = "Locais", width = 9, noRStudioGD = TRUE)
plot(spa, 
  asp = 1, 
  type = "n", 
